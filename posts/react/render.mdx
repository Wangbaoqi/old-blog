...
excerpt: Render 阶段主要创建Fiber节点，生成Fiber树，在更新阶段进行diff操作，产生具有副作用的effectList
coverImage: '/assets/blog/react/cover/render.webp'
date: '2021-07-20'
author:
  name: NateWang
...
export const cBox = (
  <Para>
    Render 阶段主要创建 <InlineCode>Fiber</InlineCode> 节点，生成 <Strong>Fiber</Strong>树，在更新阶段进行<InlineCode>diff</InlineCode>操作，产生具有副作用的<Strong>effectList</Strong>
  </Para>
)

<SideNote type='info' title='react Render 阶段' children={cBox}/>
...
![](/assets/blog/react/render/react-render.svg)
...
![](/assets/blog/react/render/render-effectList.svg)
