...
coverImage: '/assets/blog/react/cover/diff.webp'
date: '2021-07-16'
author:
  name: NateWang
...
![diff-single-loop](/assets/blog/react/diff/diff-single-loop.webp)
...
![](/assets/blog/react/diff/diif-single-m.webp)
...
![first-loop](/assets/blog/react/diff/diff-first-loop.webp)
...
![](/assets/blog/react/diff/diff-second-loop.webp)
...
![](/assets/blog/react/diff/diff-mult-update-v.webp)
...
![](/assets/blog/react/diff/diff-mult-update.webp)
...
![](/assets/blog/react/diff/diff-multi-update-Fiber.webp)
...
![](/assets/blog/react/diff/diff-multi-update-effectList.webp)
...
![](/assets/blog/react/diff/diff-multi-updatev-fiber.webp)
...
![](/assets/blog/react/diff/diff-multi-updatev-effectlist.webp)
...
![](/assets/blog/react/diff/diff-multi-add1.webp)
...
![](/assets/blog/react/diff/diff-multi-add-fiber.webp)

同理，不能复用的节点或者新增的节点都会生成Fiber节点，都没有`alternate`指向其`current Fiber`。

下面看下节点增加最后产生的**effectList**

![](/assets/blog/react/diff/diff-multi-add-effectlist.webp)
...
![](/assets/blog/react/diff/diff-mult-short.webp)
...
![](/assets/blog/react/diff/diff-multi-short-fiber.webp)

下面看下节点增加最后产生的**effectList**

![](/assets/blog/react/diff/diiff-multi-short-effectlist.webp)

### 节点移动

如下图：节点的位置发生了变化

![](/assets/blog/react/diff/diff-multi-position.webp)
...
![](/assets/blog/react/diff/diff-multi-position-fiber.webp)
...
![](/assets/blog/react/diff/diff-multi-position1.webp)
