---
title: 二叉树结构及算法
excerpt:   树是一种常用到的数据结构，不是线性存储数据的结构，它的结构比较类似组织的架构图，是一种倒过来的“树”，叶子也就是其节点，树根就是跟节点，没有子节点的节点被称为叶子节点。
coverImage: '/assets/blog/algorithm/cover/tree.jpg!s2'
...
![preOrder](https://cdn.jsdelivr.net/gh/Wangbaoqi/blogImgs@master/nateImgs/structure/tree/BST_preOrder.png)
...
![inOrder](https://cdn.jsdelivr.net/gh/Wangbaoqi/blogImgs@master/nateImgs/structure/tree/BST_inOrder.png)
...
![postOrder](https://cdn.jsdelivr.net/gh/Wangbaoqi/blogImgs@master/nateImgs/structure/tree/BST_postOrder.png)
...
![leet-code_pic](https://cdn.jsdelivr.net/gh/Wangbaoqi/blogImgs@master/nateImgs/structure/tree/bst_deletion_case\_1.png)
...
![leet-code_pic](https://cdn.jsdelivr.net/gh/Wangbaoqi/blogImgs@master/nateImgs/structure/tree/bst_deletion_case\_2.png)
...
![leet-code_pic](https://cdn.jsdelivr.net/gh/Wangbaoqi/blogImgs@master/nateImgs/structure/tree/bst_deletion_case\_3.png)
...
* [剑指 Offer 27. 二叉树的镜像](https://leetcode-cn.com/problems/二叉树-de-jing-xiang-lcof/)
...
![bst_mirror](https://cdn.jsdelivr.net/gh/Wangbaoqi/blogImgs@master/nateImgs/structure/tree/BST_mirror.png)

[LeetCode - 二叉树交换](https://leetcode-cn.com/problems/invert-binary-tree/), [LeetCode - 剑指 Offer 27. 二叉树的镜像](https://leetcode-cn.com/problems/二叉树-de-jing-xiang-lcof/)这两道题是一个意思
...
![](../.gitbook/assets/BST_same\_1.gif)
...
![k-node](https://cdn.jsdelivr.net/gh/Wangbaoqi/blogImgs@master/nateImgs/structure/tree/BST_KNode.png)
...
![DFS - depth](https://cdn.jsdelivr.net/gh/Wangbaoqi/blogImgs@master/nateImgs/structure/tree/BST_depth.png)
...
![bfs1](https://cdn.jsdelivr.net/gh/Wangbaoqi/blogImgs@master/nateImgs/structure/tree/BST_BFS.png)

初始化，将整个树压入栈，初始化深度计数器

![bfs2](https://cdn.jsdelivr.net/gh/Wangbaoqi/blogImgs@master/nateImgs/structure/tree/BST_BFS1.png)

遍历栈，此时栈中只有树一个节点，将左右子树压入临时栈中

![bfs3](https://cdn.jsdelivr.net/gh/Wangbaoqi/blogImgs@master/nateImgs/structure/tree/BST_BFS2.png)

将临时栈赋值到stack中，计数器自增

![bfs4](https://cdn.jsdelivr.net/gh/Wangbaoqi/blogImgs@master/nateImgs/structure/tree/BST_BFS3.png)
...
![](https://cdn.jsdelivr.net/gh/Wangbaoqi/blogImgs@master/nateImgs/structure/tree/bst_diameter.png)
...
![](https://cdn.jsdelivr.net/gh/Wangbaoqi/blogImgs@master/nateImgs/structure/tree/bst-right.png)
