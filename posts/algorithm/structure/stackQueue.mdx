---
title: 栈/队列结构及算法
excerpt: 栈和队列是常用的数据结构，分别有先进后出和先进先出的特性
coverImage: '/assets/blog/algorithm/cover/stack.jpg!s2'
date: '2020-03-16'
author:
  name: Nate Wang
...
![](https://cdn.jsdelivr.net/gh/Wangbaoqi/blogImgs@master/nateImgs/algorithm/queue/stack-small.png)

### 队列的实现

![](https://cdn.jsdelivr.net/gh/Wangbaoqi/blogImgs@master/nateImgs/algorithm/queue/queue_1.gif)
...
栈和队列的应用请看**常用算法**中的[栈、队列系列](https://wangbaoqi.gitbook.io/algo/常用算法系列/zhan-he-dui-lie)
