...
coverImage: '/assets/blog/algorithm/cover/sort.jpg!s2'
date: '2020-03-16'
author:
  name: Nate Wang
...
![](https://cdn.jsdelivr.net/gh/Wangbaoqi/blogImgs@master/nateImgs/algorithm/sort/bubble-sort.gif)
...
![](https://cdn.jsdelivr.net/gh/Wangbaoqi/blogImgs@master/nateImgs/algorithm/sort/select-sort.gif)
...
![](https://cdn.jsdelivr.net/gh/Wangbaoqi/blogImgs@master/nateImgs/algorithm/sort/insert-sort.gif)
...
![快速排序的图解](https://cdn.jsdelivr.net/gh/Wangbaoqi/blogImgs@master/nateImgs/algorithm/sort/quickSort.png)
...
双边循环法是在[对撞指针](双指针模式.md)的基础上，根据基准点（一般第一个元素），将小于基准点的元素移动到其左侧，大于基准点的元素移动到其右侧。
...
![](https://cdn.jsdelivr.net/gh/Wangbaoqi/blogImgs@master/nateImgs/algorithm/sort/quickSort_double.png)
...
![](https://cdn.jsdelivr.net/gh/Wangbaoqi/blogImgs@master/nateImgs/algorithm/sort/quickSort_single.png)
...
![](https://cdn.jsdelivr.net/gh/Wangbaoqi/blogImgs@master/nateImgs/algorithm/sort/gb-sort.png)
