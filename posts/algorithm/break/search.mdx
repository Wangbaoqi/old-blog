...
coverImage: '/assets/blog/algorithm/cover/search.jpg!s2'
...
因此，二分查找的时间复杂度为 ** ，**随着**n区间**越来越大，查找次数就越少
...
![](https://cdn.jsdelivr.net/gh/Wangbaoqi/blogImgs@master/nateImgs/algorithm/binarySearch/search-p.png)
...
![](https://cdn.jsdelivr.net/gh/Wangbaoqi/blogImgs@master/nateImgs/algorithm/binarySearch/pow-x.png)
...
![](https://cdn.jsdelivr.net/gh/Wangbaoqi/blogImgs@master/nateImgs/algorithm/binarySearch/guess-num.png)
...
![](https://cdn.jsdelivr.net/gh/Wangbaoqi/blogImgs@master/nateImgs/algorithm/binarySearch/search-r.png)
...
![](https://cdn.jsdelivr.net/gh/Wangbaoqi/blogImgs@master/nateImgs/algorithm/binarySearch/first-error.png)
