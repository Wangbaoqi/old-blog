---
title: HTTP Message 详细信息
excerpt: HTTP是一种能够获取HTML这样的网络资源的通讯协议。是web上进行数据交换的基础，是一种`client-server`协议。
coverImage: 'https://media.wangbaoqi.tech/assets/blog/http/cover/message.webp'
date: '2021-03-16'
author:
  name: NateWang
