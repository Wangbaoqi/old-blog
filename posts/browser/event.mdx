---
title: 'Browser 事件循环'
excerpt: '事件循环是什么？为什么会有事件循环机制？ JS是单线程的语言，如果在执行过程中遇到异步的代码，不可能一直等待（浪费资源。。。）, 至此，事件循环机制就运用而生了。'
coverImage: '/assets/blog/browser/cover/event.webp'
date: '2021-04-16'
author:
  name: NateWang
...
![JS执行顺序](/assets/blog/browser/event_1.webp)


**执行上下文**

![执行上下文](/assets/blog/browser/event_2.webp)
...
![循环机制](/assets/blog/browser/event_3.webp)
...
![xmlHttpRequest](/assets/blog/browser/event_6.webp)
...
![微任务执行时机](/assets/blog/browser/event_7.webp)

![微任务执行时机](/assets/blog/browser/event_8.webp)
...
![异步编程模型](/assets/blog/browser/event_9.webp)
...
![协程流程图](/assets/blog/browser/event_10.webp) 

![协程调用栈](/assets/blog/browser/event_11.webp)
