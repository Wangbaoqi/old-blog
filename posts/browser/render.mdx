---
title: 'Browser 的渲染'
excerpt: '上一章阐述了浏览器的架构，在最新的多进程架构中，最重要的是**渲染进程**，因为浏览器内核（渲染引擎）和JavaScript引擎（blink）都运行在该进程中。'
coverImage: '/assets/blog/browser/cover/render.webp'
date: '2021-04-19'
author:
  name: NateWang
...
![输入URL到页面展示完整流程图](/assets/blog/browser/url_load.webp)
...
![](/assets/blog/browser/input.webp)
...
![](/assets/blog/browser/browser-render.webp)
...
![](/assets/blog/browser/computedstyle.webp)
...
![](/assets/blog/browser/layout.webp)
...
![](/assets/blog/browser/layer-dom.webp)
...
![](/assets/blog/browser/paint.webp)
...
![](/assets/blog/browser/composit.webp)
...
![](/assets/blog/browser/composit-show.webp)
