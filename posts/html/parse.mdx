...
title: HTML语法 - 解析文档
date: '2021-01-23'
excerpt: HTML 解析过程的输入由一系列代码点组成，这些代码点通过一个标记化阶段，然后是树构造阶段。输出是一个 Document 对象。
coverImage: 'https://media.wangbaoqi.tech/assets/blog/html/cover/parse.webp'
author:
  name: NateWang
...
![DOM-parsing](https://media.wangbaoqi.tech/assets/blog/html/dom/dom_parse.webp)
