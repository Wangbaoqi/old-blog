...
export default function HeaderWrapper({
  ...
  return (
    <div className='bg-header-cover '>
      <div className=' relative min-h-screen-40 overflow-hidden md:block translate-y-1 z-10'>
       
        {/* <div className='absolute w-full h-full bg-cover' style={{ 'background-image': 'url(/assets/authors/bg.svg)'}} ></div> */}
