        ...
        <div className="max-w-5xl mx-auto py-8 flex mt-40 lg:px-5 px-3 flex-col md:flex-row justify-between space-y-8 lg:flex-row lg:space-y-0">
          ...
          <div className="grid grid-cols-2 text-sm sm:grid-cols-2">
            <div className="space-y-3 ">
              <p className="capitalize text-primary-color font-SourceCode opacity-80">Category</p>
            ...
            <div className="space-y-3 ml-14 md:ml-24">
              ...
              <div className="flex gap-2">
                <a href='https://twitter.com/baoqi_wang' target='_blank' title="twitter icon">
                  <Twitter size={20} className='cursor-pointer'/>
                </a>
                <a href='mailto:wangbaoqi8839@gmail.com' target='_blank' title="mail icon">
                  <Mail size={20} className='cursor-pointer'/>
                </a>
                <a href='https://leetcode.cn/u/nate-wang/' target='_blank' title="leetcode icon">
